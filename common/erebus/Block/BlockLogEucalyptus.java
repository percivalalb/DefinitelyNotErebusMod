...
public class BlockLogEucalyptus extends Block
{
    /** The type of tree this log came from. */
    public static final String[] woodType = new String[] {"eucalyptus"};
    String treeType = "eucalyptus";

    public BlockLogEucalyptus(int par1)
    {
