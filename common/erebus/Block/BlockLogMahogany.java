...
public class BlockLogMahogany extends Block
{
    /** The type of tree this log came from. */
    public static final String[] woodType = new String[] {"mahogany"};
    String treeType = "mahogany";

    public BlockLogMahogany(int par1)
    {
