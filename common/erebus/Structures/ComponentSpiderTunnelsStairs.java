...
public class ComponentSpiderTunnelsStairs extends ComponentSpiderTunnels
{
    ...
    public ComponentSpiderTunnelsStairs(int par1, Random par2Random, int par3, int par4)
    {
        super(par1);
    ...
    public ComponentSpiderTunnelsStairs(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        super(par1);
     ...
     */
    public static ComponentSpiderTunnelsStairs getSpiderTunnelsStairsComponent(List par0List, Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        StructureBoundingBox var7 = StructureBoundingBox.getComponentToAddBoundingBox(par2, par3, par4, -1, -7, 0, 5, 11, 5, par5);
        return canSpiderTunnelsGoDeeper(var7) && StructureComponent.findIntersecting(par0List, var7) == null ? new ComponentSpiderTunnelsStairs(par6, par1Random, var7, par5) : null;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            this.placeBlockAtCurrentPosition(par1World, ModBlocks.cobbleWebbed.blockID, 0, 1 + par2Random.nextInt(3), 1 + par2Random.nextInt(6), 1 + par2Random.nextInt(3), par3StructureBoundingBox);
