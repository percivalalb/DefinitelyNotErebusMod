...
public class TeleporterErebus extends Teleporter
{
    ...
    public TeleporterErebus(WorldServer par1WorldServer)
    {
            ...
            for (int var14 = -2; var14 <= 2; ++var14)
            {
                for (int var15 = -2; var15 <= 2; ++var15)
                {
                    for (int var16 = -1; var16 < 3; ++var16)
                    {
                        ...
                        this.field_85192_a.setBlock(var17, var18, var19, var20 ? Block.stoneBrick.blockID : 0, 1, 0);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        {
            PortalPositionErebus var20 = (PortalPositionErebus)this.field_85191_c.getValueByKey(var17);
            var10 = 0.0D;
            var12 = var20.posX;
            var13 = var20.posY;
            var14 = var20.posZ;
        ...
        if (var10 >= 0.0D)
        {
            if (var19)
            {
                this.field_85191_c.add(var17, new PortalPositionErebus(this, var12, var13, var14, this.field_85192_a.getTotalWorldTime()));
            ...
            //TODO Direction fix
            int var30 = /*par1Entity.getTeleportDirection()*/0;

            if (var50 > -1)
            {
            	//TODO Direction fix
                int var31 = /*Direction.rotateLeft[var50]*/0;
            ...
            for (var19 = -1; var19 <= 1; ++var19)
            {
                for (var20 = 1; var20 < 3; ++var20)
                {
                    for (var21 = -1; var21 < 3; ++var21)
                    {
                        ...
                        var33 = var21 < 0;
                        this.field_85192_a.setBlock(var22, var23, var24, var33 ? Block.stoneBrick.blockID : 0, 1, 0);
                    }
                }
            }
        }
    ...
    public void func_85189_a(long par1)
    {
        if (par1 % 100L == 0L)
        {
            ...
            while (var3.hasNext())
            {
                ...
                PortalPositionErebus var7 = (PortalPositionErebus)this.field_85191_c.getValueByKey(var6.longValue());
