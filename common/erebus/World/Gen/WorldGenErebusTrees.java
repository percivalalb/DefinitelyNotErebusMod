...
public class WorldGenErebusTrees extends WorldGenerator
{
    ...
    //Erebus Trees
    /** The block ID for the wood to use in tree generation. */
    private final int woodID;

    /** The block ID for the leaves to use in tree generation. */
    ...
    {
        this(par1, 6, 0, 0, false, mod_Erebus.woodMahogany.blockID, mod_Erebus.leavesMahogany.blockID, mod_Erebus.thorns.blockID);
    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        if (var12 == 0 || block == null || block.isLeaves(par1World, par3, par4 + var11, par5))
                        {
                            ...
                            if (this.vinesGrow && var11 > 0)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, par3 - 1, par4 + var11, par5, this.vinesID, 8);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var11, par5))
                                {
                                    this.setBlockAndMetadata(par1World, par3 + 1, par4 + var11, par5, this.vinesID, 2);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var11, par5 - 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 - 1, this.vinesID, 1);
                                }

                                if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var11, par5 + 1))
                                {
                                    this.setBlockAndMetadata(par1World, par3, par4 + var11, par5 + 1, this.vinesID, 4);
                                }
                            }
                        }
                    }
                            ...
                            for (var11 = 0; var11 < 2; ++var11)
                            {
                                for (var12 = 0; var12 < 4; ++var12)
                                {
                                    if (par2Random.nextInt(4 - var11) == 0)
                                    {
                                        ...
                                        this.setBlockAndMetadata(par1World, par3 + Direction.offsetX[ForgeDirection.OPPOSITES[var12]], par4 + var6 - 5 + var11, par5 + Direction.offsetZ[ForgeDirection.OPPOSITES[var12]], Block.cocoaPlant.blockID, var13 << 2 | var12);
                                    }
                                }
                            }
                        }
    ...
    {
        this.setBlockAndMetadata(par1World, par2, par3, par4, this.vinesID, par5);
        int var6 = 4;
