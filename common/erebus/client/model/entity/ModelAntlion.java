...
public class ModelAntlion extends ModelBase {
	...
	public ModelAntlion() {
		...
		// RM2.setRotationPoint(-9F, 18F, -8.5F);
		RM2.setTextureSize(128, 128);
		RM2.mirror = true;
		setRotation(RM2, 0F, 0F, -0.8726646F);// -0.1745329F);
		RM3 = new ModelRenderer(this, 82, 14);
		RM3.addBox(9F, -2F, -0.5F, 5, 1, 1);
		// RM3.setRotationPoint(-9F, 18F, -8.5F);
