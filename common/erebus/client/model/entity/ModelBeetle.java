...
public class ModelBeetle extends ModelBase
{
	...
	public ModelBeetle()
	{
		...
		leg1.mirror = true;
		setRotation(leg1, 0F, baseLeg1RotateY, baseLeg1RotateZ); // 0.9250245F, 0.3316126F);
		leg2 = new ModelRenderer(this, 0, 0);
		leg2.addBox(-11F, 0F, 0F, 11, 2, 2);
		leg2.setRotationPoint(-6F, 19F, -2F + centre);
		leg2.setTextureSize(128, 128);
		leg2.mirror = true;
		setRotation(leg2, 0F, baseLeg2RotateY, baseLeg2RotateZ); // 1.9750245F, 0.3316126F);
		...
		leg3.mirror = true;
		setRotation(leg3, 0F, baseLeg3RotateY, baseLeg3RotateZ); //0.0698132F, 0.3316126F);
		leg4 = new ModelRenderer(this, 0, 0);
		leg4.addBox(-11F, 0F, 0F, 11, 2, 2);
		leg4.setRotationPoint(-7F, 19F, 2F + centre);
		leg4.setTextureSize(128, 128);
		leg4.mirror = true;
		setRotation(leg4, 0F,  baseLeg4RotateY, baseLeg4RotateZ); //0F, -0.2792527F);
		...
		leg5.mirror = true;
		setRotation(leg5, 0F, baseLeg5RotateY, baseLeg5RotateZ); // -0.9599311F, 0.1570796F);
		...
		leg6.mirror = true;
		setRotation(leg6, 0F, baseLeg6RotateY, baseLeg6RotateZ); // -2.181662F, 0.1570796F);
	}
