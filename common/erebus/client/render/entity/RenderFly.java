...
public class RenderFly extends RenderLiving {
	...
	protected void preRenderCallback(EntityLiving par1EntityLiving, float par2) {
		func_82442_a((EntityFly) par1EntityLiving, par2);
	}

	protected void rotateCorpse(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		func_82444_a((EntityFly) par1EntityLiving, par2, par3, par4);
	}

	protected void renderLivingAt(EntityLiving par1EntityLiving, double par2, double par4, double par6) {
		func_82445_a((EntityFly) par1EntityLiving, par2, par4, par6);
	}

	@Override
	public void doRenderLiving(EntityLiving par1EntityLiving, double par2, double par4, double par6, float par8, float par9) {
		func_82443_a((EntityFly) par1EntityLiving, par2, par4, par6, par8, par9);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9) {
		func_82443_a((EntityFly) par1Entity, par2, par4, par6, par8, par9);
	}
