...
public class ConfigurationHandler {
	...
	public static void loadConfig(File configFile) {
		...
		try {
			...
			ModBlocks.erebusAltarHealingID = config.getBlock("Block ID of Erebus Altar Healing", 2563).getInt(2562);
			...
			// latest ID used (please update after adding new blocks!) >>> 2563
