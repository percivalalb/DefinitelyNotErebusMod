...
public class ConfigurationHandler {
	...
	public static void loadConfig(File configFile) {
		...
		try {
			...
			ModBlocks.petrifiedWoodChestID = config.getBlock("Block ID of Petrified Wood Chest", 2573).getInt(2573);
			...
			// latest ID used (please update after adding new blocks!) >>> 2573
