...
public class ConfigurationHandler {
	...
	public static void loadConfig(FMLPreInitializationEvent event) {
		...
		ModBlocks.petrifiedWoodPlanksID = config.get(config.CATEGORY_BLOCK, "Block ID of Petrified Wood Planks", 2542).getInt();
		ModBlocks.petrifiedCraftingTableID = config.get(config.CATEGORY_BLOCK, "Block ID of Petrified Crafting Table", 2543).getInt();
