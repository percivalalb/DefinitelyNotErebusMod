...
import erebus.client.render.entity.RenderRepairAltar;
...
import erebus.client.render.entity.RenderXPAltar;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderInformation() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityRepairAltar.class, new RenderRepairAltar());
		RenderingRegistry.registerEntityRenderingHandler(EntityXPAltar.class, new RenderXPAltar());
