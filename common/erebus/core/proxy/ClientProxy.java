...
import erebus.client.render.entity.RenderEngineOfIllapa;
...
import erebus.client.render.entity.RenderHealer;
...
import erebus.client.render.item.ItemHealingAltarRenderer;
...
import erebus.client.render.tileentity.TileEntityHealingAltarRenderer;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderInformation() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityEngine.class, new RenderEngineOfIllapa());
		RenderingRegistry.registerEntityRenderingHandler(EntityHealer.class, new RenderHealer());
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityLightningAltar.class, new TileEntityLightningAltarRenderer());
		ClientRegistry.bindTileEntitySpecialRenderer(TileEntityHealingAltar.class, new TileEntityHealingAltarRenderer());
		...
		MinecraftForgeClient.registerItemRenderer(ModBlocks.healingAltar.blockID, new ItemHealingAltarRenderer());
