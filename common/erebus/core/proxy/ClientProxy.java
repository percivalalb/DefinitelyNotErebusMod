...
import erebus.item.ItemLightningAltarRenderer;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderInformation() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityEngine.class, new RenderEngineOfIllapa(new ModelEngineEntity(), 0.3F));
		...
		MinecraftForgeClient.registerItemRenderer(ModBlocks.EngineOfIllapa.blockID, new ItemLightningAltarRenderer(TileEntityLightningAltarRenderer.texture));
