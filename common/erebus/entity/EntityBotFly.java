...
{
    /**
     * randomly selected ChunkCoordinates in a 7x6x7 box around the BotFly (y offset -2 to 4) towards which it will fly.
    ...
    public void onLivingUpdate()
    {
      if (!this.worldObj.isRemote)
      {
        ...
        {
        	double var1 = (double)getEntityToAttack().posX + 0.5D - this.posX;
            double var3 = (double)getEntityToAttack().posY + 1.D - this.posY;
            double var5 = (double)getEntityToAttack().posZ + 0.5D - this.posZ;
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.dataWatcher.updateObject(16, Byte.valueOf(par1NBTTagCompound.getByte("BotFly")));
    }
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setByte("BotFly", this.dataWatcher.getWatchableObjectByte(16));
    }
