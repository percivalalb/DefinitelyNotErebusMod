...
public class IEntityAIAttackOnCollide extends EntityAIBase
{
	...
	public IEntityAIAttackOnCollide(EntityCreature entityCreature, Class par2Class, double par3, boolean par5)
	{
		this(entityCreature, par3, par5);
		classTarget = par2Class;
	}

	public IEntityAIAttackOnCollide(EntityCreature entityCreature, double par2, boolean par4)
	{
