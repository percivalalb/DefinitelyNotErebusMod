...
public class ItemBambucket extends Item {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
		...
		if (movingobjectposition == null) {
			 ...
			 * par1ItemStack, par2World, movingobjectposition); if
			 * (MinecraftForge.EVENT_BUS.post(event)) { return par1ItemStack; }
			 * 
			 * if (event.getResult() == Event.Result.ALLOW) { if
			 * (par3EntityPlayer.capabilities.isCreativeMode) { return
			 * par1ItemStack; }
			 * 
			 * if (--par1ItemStack.stackSize <= 0) { return event.result; }
			 * 
			 * if (!par3EntityPlayer.inventory.addItemStackToInventory(event.
			 * result)) { par3EntityPlayer.dropPlayerItem(event.result); }
			 * 
			 * return par1ItemStack; }
			 **/
	...
	public void registerIcons(IconRegister iconRegister) {
		this.bambucket = iconRegister.registerIcon("erebus:bambucket");
		this.waterBambucket = iconRegister.registerIcon("erebus:bambucketWater");
	}
