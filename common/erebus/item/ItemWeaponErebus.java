...
public class ItemWeaponErebus extends Item
{
    ...
    public ItemWeaponErebus(int par1, int par2, int par3, int par4, int par5) {
        super(par1);
        this.maxStackSize = 1;
    ...
    {
        return this.repairMaterial == par2ItemStack.itemID ? true : super.getIsRepairable(par1ItemStack, par2ItemStack);
    }
}
