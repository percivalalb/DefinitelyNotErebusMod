...
public abstract class ItemBlockSlabGeneric extends ItemBlockGeneric{
	...
	public boolean onItemUse(ItemStack itemStack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ){
		if (this.getBlockID() == slabArray[1].blockID){
			...
			if ((side==1&&!flag||side==0&&flag)&&i1==slabArray[0].blockID&&k1==itemStack.getItemDamage()){
				...
				return this.func_77888_a(itemStack,player,world,x,y,z,side)?true:super.onItemUse(itemStack,player,world,x,y,z,side,hitX,hitY,hitZ);
			}
		}
	}
