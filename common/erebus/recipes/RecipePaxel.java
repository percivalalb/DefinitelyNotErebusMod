...
public class RecipePaxel implements IRecipe{
	...
	public boolean matches(InventoryCrafting matrix, World world){
		return checkItemInSlot(matrix,0,ModItems.jadeAxe.itemID)&&
			   checkItemInSlot(matrix,1,ModItems.jadeShovel.itemID)&&
			   checkItemInSlot(matrix,2,ModItems.jadePickaxe.itemID)&&
			   checkItemInSlot(matrix,4,Item.stick.itemID)&&
			   checkItemInSlot(matrix,7,Item.stick.itemID);
	}
