...
public class TileEntityCaveSpiderSpawner extends TileEntity {
	 ...
	 * spider, apparently.
	 */
	private String mobID = "CaveSpider";
	private List field_92016_e = null;

	/** The extra NBT data to add to spawned entities */
	private TileEntityCaveSpiderSpawnerSpawnData spawnerTags = null;
	public double yaw;
	...
	public TileEntityCaveSpiderSpawner() {
		this.delay = 20;
	}
	...
	public void setSpiderID(String par1Str, Random par2Random) {
		this.mobID = "CaveSpider";
	}
	...
	public void updateEntity() {
		if (this.anyPlayerInRange()) {
			...
			if (this.worldObj.isRemote) {
				...
				// this.worldObj.spawnParticle("flame", var1, var3, var5, 0.0D,
				// 0.0D, 0.0D);
				...
				for (int var2 = 0; var2 < this.spawnCount; ++var2) {
					...
					int var4 = this.worldObj.getEntitiesWithinAABB(var13.getClass(),
					AxisAlignedBB.getAABBPool().getAABB((double) this.xCoord, (double) this.yCoord, (double) this.zCoord, (double) (this.xCoord + 1), (double) (this.yCoord + 1), (double) (this.zCoord + 1)).expand((double) (this.spawnRange * 2), 4.0D, (double) (this.spawnRange * 2))).size();
	...
	private void updateDelay() {
		...
		if (this.field_92016_e != null && this.field_92016_e.size() > 0) {
			this.spawnerTags = (TileEntityCaveSpiderSpawnerSpawnData) WeightedRandom.getRandomItem(this.worldObj.rand, this.field_92016_e);
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		if (par1NBTTagCompound.hasKey("SpawnPotentials")) {
			...
			for (int var3 = 0; var3 < var2.tagCount(); ++var3) {
				this.field_92016_e.add(new TileEntityCaveSpiderSpawnerSpawnData(this, (NBTTagCompound) var2.tagAt(var3)));
			}
		} else {
		...
		if (par1NBTTagCompound.hasKey("SpawnData")) {
			this.spawnerTags = new TileEntityCaveSpiderSpawnerSpawnData(this, par1NBTTagCompound.getCompoundTag("SpawnData"), this.mobID);
		} else {
	...
	public void writeToNBT(NBTTagCompound par1NBTTagCompound) {
		...
		if (this.spawnerTags != null || this.field_92016_e != null && this.field_92016_e.size() > 0) {
			...
			if (this.field_92016_e != null && this.field_92016_e.size() > 0) {
				...
				while (var3.hasNext()) {
					TileEntitySpiderSpawnerSpawnData var4 = (TileEntitySpiderSpawnerSpawnData) var3.next();
