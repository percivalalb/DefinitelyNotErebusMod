...
class TileEntityCaveSpiderSpawnerSpawnData extends WeightedRandomItem {
	public final NBTTagCompound field_92032_b;
	public final String field_92033_c;

	final TileEntityCaveSpiderSpawner field_92031_d;

	public TileEntityCaveSpiderSpawnerSpawnData(TileEntityCaveSpiderSpawner par1TileEntitySpiderSpawner, NBTTagCompound par2NBTTagCompound) {
	...
	public TileEntityCaveSpiderSpawnerSpawnData(TileEntityCaveSpiderSpawner par1TileEntitySpiderSpawner, NBTTagCompound par2NBTTagCompound, String par3Str) {
		super(1);
		this.field_92031_d = par1TileEntitySpiderSpawner;
