...
public class TileEntitySpiderSpawner extends TileEntity {
	 ...
	 * spider, apparently.
	 */
	private String mobID = "Spider";
	private List field_92016_e = null;

	/** The extra NBT data to add to spawned entities */
	private TileEntitySpiderSpawnerSpawnData spawnerTags = null;
	public double yaw;
	...
	public TileEntitySpiderSpawner() {
		this.delay = 20;
	}
	...
	private void updateDelay() {
		...
		if (this.field_92016_e != null && this.field_92016_e.size() > 0) {
			this.spawnerTags = (TileEntitySpiderSpawnerSpawnData) WeightedRandom.getRandomItem(this.worldObj.rand, this.field_92016_e);
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound) {
		...
		if (par1NBTTagCompound.hasKey("SpawnPotentials")) {
			...
			for (int var3 = 0; var3 < var2.tagCount(); ++var3) {
				this.field_92016_e.add(new TileEntitySpiderSpawnerSpawnData(this, (NBTTagCompound) var2.tagAt(var3)));
			}
		} else {
		...
		if (par1NBTTagCompound.hasKey("SpawnData")) {
			this.spawnerTags = new TileEntitySpiderSpawnerSpawnData(this, par1NBTTagCompound.getCompoundTag("SpawnData"), this.mobID);
		} else {
