    ...
    public void func_4058_b(int par1, int par2, byte par3ArrayOfByte[])
    {
        ...
        for (int i = 0; i < 16; i++)
        {
            for (int j = 0; j < 16; j++)
            {
                ...
                byte byte2 = (byte)ModBlocks.umberstone.blockID;
                ...
                for (int i1 = 127; i1 >= 0; i1--)
                {
                    ...
                    if (l == -1)
                    {
                        if (k <= 2)
                        {
                            ...
                            byte2 = (byte)ModBlocks.umberstone.blockID;
                        }
            ...
            for (int var9 = 0; var9 < 16; ++var9)
            {
                ...
                for (int var16 = 127; var16 >= 0; --var16)
                {
                    ...
                    else
                    {
                        ...
                        else if (var18 == ModBlocks.umberstone.blockID || var18 == ModBlocks.umberstoneID - 256) //Double check for the "itemblock"
                        {
                            if (var13 == -1)
                            {
                                if (var12 <= 0)
                                {
                                    var14 = 0;
                                    var15 = (byte)ModBlocks.umberstone.blockID;
                                }
