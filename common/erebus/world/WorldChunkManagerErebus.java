...
public class WorldChunkManagerErebus extends WorldChunkManager {
	 ...
	 * par2, par3, par4, par5); IntCache.resetIntCache();
	 * 
	 * if (par1ArrayOfBiomeGenBase == null || par1ArrayOfBiomeGenBase.length <
	 * par4 * par5) { par1ArrayOfBiomeGenBase = new BiomeGenBase[par4 * par5]; }
	 * 
	 * if (par6 && par4 == 16 && par5 == 16 && (par2 & 15) == 0 && (par3 & 15)
	 * == 0) { BiomeGenBase[] var9 = this.biomeCache.getCachedBiomes(par2,
	 * par3); System.arraycopy(var9, 0, par1ArrayOfBiomeGenBase, 0, par4 *
	 * par5); return par1ArrayOfBiomeGenBase; } else { return
	 ...
	 * par4List, Random par5Random) { return
	 * par4List.contains(this.biomeGenerator) ? new ChunkPosition(par1 - par3 +
