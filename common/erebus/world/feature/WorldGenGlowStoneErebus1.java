...
public class WorldGenGlowStoneErebus1 extends WorldGenerator
{
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        {
            par1World.setBlock(par3, par4, par5, Block.glowStone.blockID);
            ...
            for (int var6 = 0; var6 < 1500; ++var6)
            {
                ...
                if (par1World.getBlockId(var7, var8, var9) == 0)
                {
                    ...
                    if (var10 == 1)
                    {
                        par1World.setBlock(var7, var8, var9, Block.glowStone.blockID);
                    }
                }
            }
