...
public class WorldGenMossbarkTree extends WorldGenerator{
	...
	public boolean generate(World world, Random random, int x, int y, int z){
		...
		y+=stumpHeight;
		for(int a=0; a<4; a++)generateMiddleBranch(world,random,x+offsetX[a]*2,y,z+offsetZ[a]*2,middleBranchHeights[a]);
		for(int a=0; a<4; a++)generateOutsideBranch(world,random,x+offsetX[a]*3,y+middleBranchHeights[a],z+offsetZ[a]*3,outsideBranchHeights[a]);
