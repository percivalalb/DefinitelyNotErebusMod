...
public class ItemErebusFood extends ItemFood
{
    ...
    public ItemErebusFood(int par1, int par2, float par3, boolean par4)
    {
    ...
    public ItemErebusFood(int par1, int par2, boolean par3)
    {
     ...
     */
    public ItemErebusFood setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
     ...
     */
    public ItemErebusFood setAlwaysEdible()
    {
