...
import erebus.Entity.EntityBeetleLarvaNoises;
import erebus.Entity.EntityCentipede;
import erebus.Entity.EntityFly;
import erebus.Entity.EntityFlyNoises;
...
/*@ForgeSubscribe
  ...
  try{
  event.manager.soundPoolSounds.addSound("Erebus/mosquito_flying.ogg", mod_Erebus.class.getResource("/Erebus/Sound/mosquito_flying.ogg"));
  } catch(Exception exception){
  System.err.println("Failed To Register Sound: " + exception.getMessage());
  }
  try{
  event.manager.soundPoolSounds.addSound("Erebus/mosquito_hit.ogg", mod_Erebus.class.getResource("/Erebus/Sound/mosquito_hit.ogg"));
  } catch(Exception exception){
  System.err.println("Failed To Register Sound: " + exception.getMessage());
  }
  try{
  event.manager.soundPoolSounds.addSound("Erebus/mosquito_death.ogg", mod_Erebus.class.getResource("/Erebus/Sound/mosquito_death.ogg"));
  } catch(Exception exception){
  System.err.println("Failed To Register Sound: " + exception.getMessage());
  }
  try{
  event.manager.soundPoolSounds.addSound("Erebus/mosquito_sucking.ogg", mod_Erebus.class.getResource("/Erebus/Sound/mosquito_sucking.ogg"));
  } catch(Exception exception){
  System.err.println("Failed To Register Sound: " + exception.getMessage());
  }
  }*/
